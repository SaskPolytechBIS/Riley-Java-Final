...
public class ClientConsole implements ChatIF {
    ...
    public static void main(String[] args) {
        ...
        try {
            //try to grab connection info from the arguments
            host = args[0];
    ...
    public void accept() {
        try {
            //this works like a scanner to read keyboard input
            BufferedReader fromConsole
                    = new BufferedReader(new InputStreamReader(System.in));
            String message;

            while (true) {
                //accepts message from keyboard
                message = fromConsole.readLine();
                // sends message to ChatClient class
